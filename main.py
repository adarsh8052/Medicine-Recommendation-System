...
def home():
    if request.method == 'POST':
        ...
        if not symptoms or symptoms.strip() == "" or symptoms == "Symptoms":
            message = "Please enter valid symptoms (e.g., fever, cough, headache)"
        ...
        try:
            ...
            if invalid_symptoms:
                message = f"Following symptoms are not recognized: {', '.join(invalid_symptoms)}. Please check spelling."
                return render_template('index.html', message=message)
            ...
            message = "Error processing symptoms. Please check the format and try again."
            return render_template('index.html', message=message)
